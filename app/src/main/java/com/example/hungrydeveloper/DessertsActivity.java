...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dessertList = findViewById(R.id.list_view_desserts);
        ...
        ArrayAdapter<Dish> dessertAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,dessertDish);
